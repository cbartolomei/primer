...
const TOPICS = [
  {
    ...
    title: 'HTTP & APIs',
    icon: '🌐',
    desc: 'HTTP methods, REST, GraphQL, gRPC, WebSockets, TLS, DNS',
  ...
  },
  {
    ...
    title: 'Databases',
    icon: '🗄️',
    desc: 'ACID, isolation levels, indexing, PostgreSQL, NoSQL, sharding',
  ...
  },
  {
    ...
    title: 'Caching',
    icon: '⚡',
    desc: 'Cache strategies, Redis data structures, CDN, HTTP caching',
  ...
  },
  {
    ...
    title: 'System Design',
    icon: '🏗️',
    desc: 'Scaling, load balancing, CAP, rate limiting, microservices patterns',
  ...
  },
  {
    ...
    title: 'Security',
    icon: '🔐',
    desc: 'Auth, JWT, OAuth 2.0, CORS, OWASP, XSS, CSRF, secrets',
  ...
  },
  {
    ...
    icon: '📦',
    desc: 'Docker, Kubernetes, CI/CD, observability, GitOps',
